...
import { ChartComponent, ApexAxisChartSeries, ApexChart, ApexFill, ApexYAxis, ApexTooltip, ApexMarkers, ApexXAxis, ApexPlotOptions, ApexStroke, ApexLegend, ApexDataLabels, ApexGrid, NgApexchartsModule } from 'ng-apexcharts';
